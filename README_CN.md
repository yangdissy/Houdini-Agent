...
| 上下文管理 | 普通发送与 413 恢复使用同一轮次安全压缩，工具 schema 计入 token 预算 |
| Memory 正确性 | embedding provenance 校验，个人/团队 Memory 支持可回滚迁移 |

最新更新：[2026-08-17～18 可靠性与治理深化](changelog/CHANGELOG_2026-08-18.md)。详细历史见 [changelog/](changelog/)。
